...
from app.repositories.user_ingredient_repository import create_user_ingredient, create_user_ingredient_uncommitted, get_ingredients_by_user_id, delete_user_ingredient, get_user_ingredient_names
...
def get_user_ingredient_name_list(db: Session, user_id: int) -> list[str]:
    return get_user_ingredient_names(db, user_id)
